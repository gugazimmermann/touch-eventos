...
const RegisterByAgeBarGraph = ({ question, answers }) => {
  ...
  useEffect(() => {
    ...
    answers.forEach((item) => {
      ...
      groupedByDateTime[dateTime][answerKey] = (groupedByDateTime[dateTime][answerKey] || 0) + item.total_answer;
    });
      ...
      <ResponsiveContainer width="100%" height={300}>
        ...
        >
          ...
          {[
            ...
            <Bar key={age} dataKey={age} fill={COLORS[index]} />
          ))}
        </BarChart>
      </ResponsiveContainer>
    </div>
...
export default RegisterByAgeBarGraph;
