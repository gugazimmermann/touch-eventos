...
const newEventValidate = (values, verifyDates, setError, t) => {
  ...
  if (!validateCep(values.addressZipCode)) return showError("account_address_zipcode_invalid");
  if (
...
export default newEventValidate;
